export const translations = {
  en: {
    ...
    nav: {
      ...
      contact: "Contact",
      systemsEngineer: "Full-Stack Engineer & Architect",
      contactBtn: "CONTACT",
    ...
    contact: {
      ...
      description: "Open to Full-Stack and Software Engineering roles, architecture ownership, and teams that want AI leverage without losing control of their codebase.",
      availability: "Available for remote roles · UTC-5 · English C1",
      copied: "Email copied",
  ...
  es: {
    ...
    nav: {
      ...
      contact: "Contacto",
      systemsEngineer: "Ingeniero Full-Stack y Arquitecto",
    ...
    contact: {
      ...
      description: "Disponible para roles Full-Stack e Ingeniería de Software, para hacerme cargo de la arquitectura y para equipos que quieren el apalancamiento de la IA sin perder el control de su código.",
      availability: "Disponible para roles remotos · UTC-5 · Inglés C1",
